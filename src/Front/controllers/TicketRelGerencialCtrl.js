...
app.controller("TicketRelGerencialCtrl", function($scope, $sce, PerfilAcessoRotinaAPIService, TicketAPIService, CategoriaTicketAPIService, OrigemTicketAPIService, GrupoTrabalhoAPIService, PastaTrabalhoAPIService, PrioridadeTicketAPIService, SituacaoTicketAPIService, TipoAtividadeAPIService, UsuarioAPIService, ReportAPIService, $location, $filter, $routeParams, growl, config){
	...
	$scope.$on('$viewContentLoaded', function() {
    	...
    	setTimeout(function(){			
		    ...
		    $scope.reportFilter.tkt_rel_gen_data_de = moment(new Date(primeiroDia), "Y-m-d").format("DD/MM/YYYY");
		    $scope.reportFilter.tkt_rel_gen_data_ate = moment(new Date(ultimoDia), "Y-m-d").format("DD/MM/YYYY");
		
		    $("#tkt_rel_gen_data_de").datepicker('setDate', $scope.reportFilter.tkt_rel_gen_data_de);
		    $("#tkt_rel_gen_data_ate").datepicker('setDate', $scope.reportFilter.tkt_rel_gen_data_ate);
	...
	$scope.generateReport  = function(RptFilter) {
		...
		ReportAPIService.TicketGerencialReport(RptFilter).then(function(response){
	...
	$scope.getUserAccess = function() {
		PerfilAcessoRotinaAPIService.getLoggedUsuariorRotina('ticket_rel_gerencial').then(function(response){
			$('#div-loading').hide();
    ...
    $scope.aTipoRel = [
    	{tpr_id: "1", tpr_descr: "Novos Tickets por Solicitante"},
    	{tpr_id: "2", tpr_descr: "Novos Tickets por Responsável"},
    	{tpr_id: "3", tpr_descr: "Novos Tickets por Dia"},
    	{tpr_id: "4", tpr_descr: "Tickets encerradas por Solicitante"},
    	{tpr_id: "5", tpr_descr: "Tickets encerradas por Responsável"},
    	{tpr_id: "6", tpr_descr: "Tickets encerradas por Dia"},
    	{tpr_id: "7", tpr_descr: "Horas apontadas por Solicitante"},
    	{tpr_id: "8", tpr_descr: "Horas apontadas por Responsável"},
    	{tpr_id: "9", tpr_descr: "Horas apontadas por Dia"}
	];
	...
	$('#tkt_rel_gen_data_de').datepicker({
		format: 'dd/mm/yyyy',
		language: 'pt-BR',
		locale: 'pt',
		todayBtn: true,
		...
		$scope.reportFilter.tkt_rel_gen_data_de = moment(new Date(e.date), "Y-m-d").format("DD/MM/YYYY");
	});

	$('#tkt_rel_gen_data_ate').datepicker({
		format: 'dd/mm/yyyy',
		language: 'pt-BR',
		locale: 'pt',
		todayBtn: true,
		...
		$scope.reportFilter.tkt_rel_gen_data_ate = moment(new Date(e.date), "Y-m-d").format("DD/MM/YYYY");
	});
});	
