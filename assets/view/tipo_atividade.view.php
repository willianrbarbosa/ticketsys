		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="#/novotipoatividade" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-sm btn-primary" title="Adicionar novo cadastro">
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item" ng-if="!lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="deletaTipoAtividade(aTipoAtividade)" class="kt-nav__link">
							...
							<li class="kt-nav__item" ng-if="!lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="loadTipoAtividadeDeletados(cFiltroManual)" class="kt-nav__link">
									<i class="kt-nav__link-icon fa fa-md fa-times ft-danger"></i> <span class="kt-nav__link-text">Mostrar Excluídos</span>
								</a>
							</li>
							<li class="kt-nav__item" ng-if="lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="loadTipoAtividade(cFiltroManual)" class="kt-nav__link">
									<i class="kt-nav__link-icon fa fa-md fa-check ft-success"></i> <span class="kt-nav__link-text">Mostrar Ativos</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Cadastro de Tipos de Atividade', 'Cadastros', '#'+url)" class="kt-nav__link">
							...
							<li class="kt-nav__separator"></li>
							<li class="kt-nav__item">
								<a href="" class="kt-nav__link" ng-click="exportaDados('Tipos de Atividade', 'tbTipoAtividade', 'EXCEL')">
									<i class="kt-nav__link-icon fa fa-file-excel-o ft-success"></i>
									<span class="kt-nav__link-text">EXCEL</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="" class="kt-nav__link" ng-click="exportaDados('Tipos de Atividade', 'tbTipoAtividade', 'PDF')">
	...
	<div class="row">
		<div class="col-xs-12 kt-portlet" >	
			...
			<div class="row kt-portlet__head kt-portlet__head--sm" style="padding-top: 15px;">
				<div class="col-xs-offset-6 col-xs-6" ng-show="aUserAccess.pta_nivel">
				    <div class="input-group input-group-info right-justify" ng-show="aUserAccess.pta_nivel">
			        	...
			        	<span class="input-group-addon my-control search-addon"><a href="" ng-click="(lDeleted ? loadTipoAtividadeDeletados(cFiltroManual) : loadTipoAtividade(cFiltroManual))"><i class="ace-icon fa fa-search nav-search-icon"></i></a></span>
				    </div>
			...
			<div class="kt-portlet__body" >
				...
				<div class="alert alert-warning" ng-if="!aTipoAtividade.length">
					<span id="loading"><div class="loading-img"> Carregando listagem de Tipos de Atividade. Aguarde...</div></span>
				</div>

				<div ng-if="aTipoAtividade.length && aUserAccess.pta_nivel">
					<div class="table-responsive">
						<table class="table table-striped display nowrap" id="tbTipoAtividade">
							<thead class="thead">
								<tr>
									<th export-no-show>
									...
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('tav_id')">Reg.</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('tav_descricao')">Descrição</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('tav_incdate')">Data inc.</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('tav_upddate')">Data alt.</a></th>
									<th class="text-nowrap" ng-if="lDeleted"><a href="" ng-click="ordenarPor('tav_deldate')">Data exc.</a></th>
									<th class="text-nowrap" ng-if="lDeleted"><a href="" ng-click="ordenarPor('tav_deluser')">Usuário exc.</a></th>
								</tr>
							</thead>	
							<tbody>	
								<tr ng-class="{'selecionado negrito': tipoatividade.selecionado, 'text-danger': lDeleted}"  ng-repeat="tipoatividade in aTipoAtividade | filter: iptsearch | startFrom:currentPage*numPerPage | limitTo:numPerPage | orderBy: criterioOrdenacao: direcaoOrdenacao">
									<td export-no-show>
										<label class="control control--checkbox" ng-if="aUserAccess.pta_nivel >= 3">
											<input type="checkbox" value="None" id="squaredFour{{tipoatividade.tav_id}}" name="check{{tipoatividade.tav_id}}" ng-model="tipoatividade.selecionado" />
											<div class="control__indicator"></div>
										</label>
									</td>
									<td class="text-nowrap">
										<a href="#/editatipoatividade/{{tipoatividade.tav_id}}" ng-if="aUserAccess.pta_nivel >= 2 && !lDeleted" class="btn btn-xs btn-link" title="Editar Tipo de Atividade"><i class="fa fa-edit"></i></a>
									</td>
									<td class="text-nowrap">{{tipoatividade.tav_id}}</td>
									<td class="text-nowrap">{{tipoatividade.tav_descricao}}</td>
									<td class="text-nowrap">{{tipoatividade.tav_incdate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap">{{tipoatividade.tav_upddate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap" ng-if="lDeleted">{{tipoatividade.tav_deldate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap" ng-if="lDeleted">{{tipoatividade.tav_deluser | date:'dd/MM/yyyy HH:mm:ss'}}</td>
								</tr>
							</tbody> 
						</table>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="text-align: justify;">
				<div class="row form-group" ng-show="aUserAccess.pta_nivel">
					...
					<div class="col-sm-9" >
						<select  class="form-control my-control-sel" ng-model="filterFieldBD">
							<option value=""></option>
							<option value="tav_id">Reg.</option>
							<option value="tav_descricao">Descrição</option>
							<option value="tav_incdate">Data inc.</option>
							<option value="tav_upddate">Data alt.</option>
							<option value="tav_deldate">Data exc.</option>
							<option value="tav_deluser">Usuário exc..</option>
						</select>
					</div>
				</div>
				...
				<div class="row form-group" ng-show="aUserAccess.pta_nivel">
					...
					<div class="col-sm-6" >
						<input class="form-control my-control iptdata" type="text" placeholder="Digite o conteúdo do filtro..." ng-model="cfilterBD" ng-show="filterFieldBD == 'tav_incdate' || filterFieldBD == 'tav_upddate' || filterFieldBD == 'tav_deldate'">
						<input class="form-control my-control" type="text" placeholder="Digite o conteúdo do filtro..." ng-model="cfilterBD" ng-show="filterFieldBD != 'tav_incdate' && filterFieldBD != 'tav_upddate' && filterFieldBD != 'tav_deldate'">
					</div>
				...
				<div class="row">
			      	<div class="col-sm-12 right-justify">
			      		<div class="col-sm-4 col-sm-offset-6" style="margin-right: -20px;">
							<a href="" class="btn-block btn btn-xs btn-primary" data-dismiss="modal" ng-click="(lDeleted ? loadTipoAtividadeDeletados(cFiltroManual) : loadTipoAtividade(cFiltroManual))">Aplicar filtro informado</a>
						</div>		
						<div class="col-sm-2">
