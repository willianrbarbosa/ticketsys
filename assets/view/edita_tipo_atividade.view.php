		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 2" class="btn btn-xs btn-primary btn-salvar" ng-click="edtForm.$invalid || editaTipoAtividade(eTipoAtividade)" ng-disabled="edtForm.$invalid">
						Salvar
					</a>
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Editar Tipo de Atividade ' + eTipoAtividade.tav_descricao, 'Cadastros', '#'+url)" class="kt-nav__link">
				...
				<form name="edtForm" role="form" ng-show="aUserAccess.pta_nivel >= 2">
					<div class="form-group row">
				        <div class="col-sm-2">
				            ...
				            <input type="text" name="nov_tav_id" id="nov_tav_id" ng-maxlength="11" class="form-control my-control" ng-model="eTipoAtividade.tav_id" readonly />
				        </div>
						<div class="col-sm-10" ng-class="{ 'has-error': (edtForm.nov_tav_descricao.$dirty && edtForm.nov_tav_descricao.$error.required) || edtForm.nov_tav_descricao.$error.maxlength }">
							<label>Descrição</label><span class="txt-obg">*</span>
							<input type="text" name="nov_tav_descricao" id="nov_tav_descricao"  ng-maxlength="50" maxlength="50" class="form-control my-control" ng-model="eTipoAtividade.tav_descricao"  required/>
						</div>
                    </div>
               </form>
