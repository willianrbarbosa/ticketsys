		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-primary btn-salvar" ng-click="newForm.$invalid || novoPastaTrabalho(nPastaTrabalho, true)" ng-disabled="newForm.$invalid">
						Salvar
					</a>
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-success btn-salvar" ng-click="newForm.$invalid || novoPastaTrabalho(nPastaTrabalho, false)" ng-disabled="newForm.$invalid">
						Salvar e Cad. Novo
					</a>
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Nova Pasta de Trabalho', 'Cadastros', '#'+url)" class="kt-nav__link">
					...
					<form name="newForm" role="form" ng-show="aUserAccess.pta_nivel >= 1">
						<div class="form-group row">
					        <div class="col-sm-2">
					            ...
					            <input type="text" name="nov_pst_id" id="nov_pst_id" ng-maxlength="11" class="form-control my-control" ng-model="nPastaTrabalho.pst_id" readonly />
					        </div>
						</div>
						<div class="form-group row">
							<div class="col-sm-6" ng-class="{ 'has-error': (newForm.nov_pst_descricao.$dirty && newForm.nov_pst_descricao.$error.required) || newForm.nov_pst_descricao.$error.maxlength }">
								<label>Descrição</label><span class="txt-obg">*</span>
								<input type="text" name="nov_pst_descricao" id="nov_pst_descricao"  ng-maxlength="50" maxlength="50" class="form-control my-control" ng-model="nPastaTrabalho.pst_descricao"  required/>
							</div>
							<div class="col-sm-6" ng-class="{ 'has-error': newForm.nov_pst_grt_id.$dirty && newForm.nov_pst_grt_id.$error.required}">
								<label>Grupo de Trabalho</label><span class="txt-obg">*</span>
								<selectize id="nov_pst_grt_id" name="nov_pst_grt_id" config="cfgGrupoTrabalho" options="aGrupoTrabalho" ng-model="nPastaTrabalho.pst_grt_id" required></selectize>
							</div>
                        </div>
                   </form>
