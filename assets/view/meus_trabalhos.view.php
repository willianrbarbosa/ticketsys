	...
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				...
				<a href="#/ticket" class="kt-subheader__breadcrumbs-link bold">&nbsp;Meus Trabalhos</a>
			</div>
		</div>
		...
		<div class="col-xs-12 kt-portlet" >	
			...
			<div class="row kt-portlet__head kt-portlet__head--sm" style="padding-top: 15px;">
				<div class="col-xs-offset-6 col-xs-6" ng-show="aUserAccess.pta_nivel">
				    <div class="input-group input-group-info right-justify" ng-show="aUserAccess.pta_nivel">
			        	...
			        	<span class="input-group-addon my-control search-addon"><a href="" ng-click="loadMeusTrabalhos(cFiltroManual)"><i class="ace-icon fa fa-search nav-search-icon"></i></a></span>
				    </div>
			...
			<div class="kt-portlet__body" >
				...
				<div class="alert alert-warning" ng-if="!aTicket.length">
					<span id="loading"><div class="loading-img"> Carregando listagem de Tickets. Aguarde...</div></span>
				</div>
				...
				<div ng-if="aTicket.length && aUserAccess.pta_nivel">
					<div class="table-responsive">
						<table class="table table-striped display nowrap" id="tbTicket">
							...
							<tbody>	
								<tr ng-class="{'text-primary bold': ticket.tkt_aprovado == 'S'}"  ng-repeat="ticket in aTicket | filter: iptsearch | startFrom:currentPage*numPerPage | limitTo:numPerPage | orderBy: criterioOrdenacao: direcaoOrdenacao">
									<td export-no-show>
										<label class="control control--checkbox" ng-if="aUserAccess.pta_nivel >= 3">
									...
									<td class="text-nowrap">
										<a href="#/detalheticket/{{ticket.tkt_id}}" ng-if="aUserAccess.pta_nivel >= 2" class="btn btn-xs btn-link" title="Editar Ticket">#{{ticket.tkt_id}}</a>
									</td>
				...
				<div class="row">
			      	<div class="col-sm-12 right-justify">
			      		<div class="col-sm-4 col-sm-offset-6" style="margin-right: -20px;">
							<a href="" class="btn-block btn btn-xs btn-primary" data-dismiss="modal" ng-click="loadMeusTrabalhos(cFiltroManual)">Aplicar filtro informado</a>
						</div>		
						<div class="col-sm-2">
