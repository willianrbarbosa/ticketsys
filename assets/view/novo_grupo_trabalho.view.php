		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-primary btn-salvar" ng-click="newForm.$invalid || novoGrupoTrabalho(nGrupoTrabalho, true)" ng-disabled="newForm.$invalid">
						Salvar
					</a>
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-success btn-salvar" ng-click="newForm.$invalid || novoGrupoTrabalho(nGrupoTrabalho, false)" ng-disabled="newForm.$invalid">
						Salvar e Cad. Novo
					</a>
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="#/grupotrabalho" class="kt-nav__link">
									<i class="kt-nav__link-icon fa fa-md fa-chevron-left ft-primary"></i> <span class="kt-nav__link-text">Voltar à listagem</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Novo Grupo de Trabalho', 'Cadastros', '#'+url)" class="kt-nav__link">
		...
		<div class="col-xs-12 kt-portlet" >	
			...
			<div class="kt-portlet__body">
				...
				<div class="alert alert-warning" ng-if="!aUserAccess.pta_nivel || aUserAccess.pta_nivel < 1">
					...
					<a href="#/grupotrabalho" class="btn-xs btn-link" >Voltar à listagem</a>
				</div>
					...
					<form name="newForm" role="form" ng-show="aUserAccess.pta_nivel >= 1">
						<div class="form-group row">
					        <div class="col-sm-2">
					            ...
					            <input type="text" name="nov_grt_id" id="nov_grt_id" ng-maxlength="11" class="form-control my-control" ng-model="nGrupoTrabalho.grt_id" readonly />
					        </div>
								<div class="col-sm-10" ng-class="{ 'has-error': (newForm.nov_grt_descricao.$dirty && newForm.nov_grt_descricao.$error.required) || newForm.nov_grt_descricao.$error.maxlength }">
								  <label>Descrição</label><span class="txt-obg">*</span>
								  <input type="text" name="nov_grt_descricao" id="nov_grt_descricao"  ng-maxlength="50" maxlength="50" class="form-control my-control" ng-model="nGrupoTrabalho.grt_descricao"  required/>
								</div>
                            </div>
                       </form>
