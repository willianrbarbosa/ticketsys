		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="#/novoprioridadeticket" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-sm btn-primary" title="Adicionar novo cadastro">
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item" ng-if="!lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="deletaPrioridadeTicket(aPrioridadeTicket)" class="kt-nav__link">
							...
							<li class="kt-nav__item" ng-if="!lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="loadPrioridadeTicketDeletados(cFiltroManual)" class="kt-nav__link">
									<i class="kt-nav__link-icon fa fa-md fa-times ft-danger"></i> <span class="kt-nav__link-text">Mostrar Excluídos</span>
								</a>
							</li>
							<li class="kt-nav__item" ng-if="lDeleted && aUserAccess.pta_nivel >= 3">
								<a href="" ng-click="loadPrioridadeTicket(cFiltroManual)" class="kt-nav__link">
									<i class="kt-nav__link-icon fa fa-md fa-check ft-success"></i> <span class="kt-nav__link-text">Mostrar Ativos</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Cadastro de Prioridades de Ticket', 'Cadastros', '#'+url)" class="kt-nav__link">
							...
							<li class="kt-nav__separator"></li>
							<li class="kt-nav__item">
								<a href="" class="kt-nav__link" ng-click="exportaDados('Prioridades de Ticket', 'tbPrioridadeTicket', 'EXCEL')">
									<i class="kt-nav__link-icon fa fa-file-excel-o ft-success"></i>
									<span class="kt-nav__link-text">EXCEL</span>
								</a>
							</li>
							<li class="kt-nav__item">
								<a href="" class="kt-nav__link" ng-click="exportaDados('Prioridades de Ticket', 'tbPrioridadeTicket', 'PDF')">
	...
	<div class="row">
		<div class="col-xs-12 kt-portlet" >	
			...
			<div class="row kt-portlet__head kt-portlet__head--sm" style="padding-top: 15px;">
				<div class="col-xs-offset-6 col-xs-6" ng-show="aUserAccess.pta_nivel">
				    <div class="input-group input-group-info right-justify" ng-show="aUserAccess.pta_nivel">
			        	...
			        	<span class="input-group-addon my-control search-addon"><a href="" ng-click="(lDeleted ? loadPrioridadeTicketDeletados(cFiltroManual) : loadPrioridadeTicket(cFiltroManual))"><i class="ace-icon fa fa-search nav-search-icon"></i></a></span>
				    </div>
			...
			<div class="kt-portlet__body" >
				...
				<div class="alert alert-warning" ng-if="!aPrioridadeTicket.length">
					<span id="loading"><div class="loading-img"> Carregando listagem de Prioridade de Ticket. Aguarde...</div></span>
				</div>

				<div ng-if="aPrioridadeTicket.length && aUserAccess.pta_nivel">
					<div class="table-responsive">
						<table class="table table-striped display nowrap" id="tbPrioridadeTicket">
							<thead class="thead">
								<tr>
									<th export-no-show>
									...
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_id')">Reg.</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_prioridade')">Prioridade</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_descricao')">Descrição</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_cor')">Cor</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_incdate')">Data inc.</a></th>
									<th class="text-nowrap"><a href="" ng-click="ordenarPor('prt_upddate')">Data alt.</a></th>
									<th class="text-nowrap" ng-if="lDeleted"><a href="" ng-click="ordenarPor('prt_deldate')">Data exc.</a></th>
									<th class="text-nowrap" ng-if="lDeleted"><a href="" ng-click="ordenarPor('prt_deluser')">Usuário exc.</a></th>
								</tr>
							</thead>	
							<tbody>	
								<tr ng-class="{'selecionado negrito': prioridadeticket.selecionado, 'text-danger': lDeleted}"  ng-repeat="prioridadeticket in aPrioridadeTicket | filter: iptsearch | startFrom:currentPage*numPerPage | limitTo:numPerPage | orderBy: criterioOrdenacao: direcaoOrdenacao">
									<td export-no-show>
										<label class="control control--checkbox" ng-if="aUserAccess.pta_nivel >= 3">
											<input type="checkbox" value="None" id="squaredFour{{prioridadeticket.prt_id}}" name="check{{prioridadeticket.prt_id}}" ng-model="prioridadeticket.selecionado" />
											<div class="control__indicator"></div>
										</label>
									</td>
									<td class="text-nowrap">
										<a href="#/editaprioridadeticket/{{prioridadeticket.prt_id}}" ng-if="aUserAccess.pta_nivel >= 2 && !lDeleted" class="btn btn-xs btn-link" title="Editar Prioridade de Ticket"><i class="fa fa-edit"></i></a>
									</td>
									<td class="text-nowrap">{{prioridadeticket.prt_id}}</td>
									<td class="text-nowrap">{{prioridadeticket.prt_prioridade}}</td>
									<td class="text-nowrap">{{prioridadeticket.prt_descricao}}</td>
									<td class="text-nowrap"><i class="fa fa-2x fa-square" style="color: {{prioridadeticket.prt_cor}};"></</td>
									<td class="text-nowrap">{{prioridadeticket.prt_incdate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap">{{prioridadeticket.prt_upddate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap" ng-if="lDeleted">{{prioridadeticket.prt_deldate | date:'dd/MM/yyyy HH:mm:ss'}}</td>
									<td class="text-nowrap" ng-if="lDeleted">{{prioridadeticket.prt_deluser | date:'dd/MM/yyyy HH:mm:ss'}}</td>
								</tr>
							</tbody> 
						</table>
					</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body" style="text-align: justify;">
				<div class="row form-group" ng-show="aUserAccess.pta_nivel">
					...
					<div class="col-sm-9" >
						<select  class="form-control my-control-sel" ng-model="filterFieldBD">
							<option value=""></option>
							<option value="prt_id">Reg.</option>
							<option value="prt_prioridade">Prioridade</option>
							<option value="prt_descricao">Descrição</option>
							<option value="prt_incdate">Data inc.</option>
							<option value="prt_upddate">Data alt.</option>
							<option value="prt_deldate">Data exc.</option>
							<option value="prt_deluser">Usuário exc..</option>
						</select>
					</div>
				</div>
				...
				<div class="row form-group" ng-show="aUserAccess.pta_nivel">
					...
					<div class="col-sm-6" >
						<input class="form-control my-control iptdata" type="text" placeholder="Digite o conteúdo do filtro..." ng-model="cfilterBD" ng-show="filterFieldBD == 'prt_incdate' || filterFieldBD == 'prt_upddate' || filterFieldBD == 'prt_deldate'">
						<input class="form-control my-control" type="text" placeholder="Digite o conteúdo do filtro..." ng-model="cfilterBD" ng-show="filterFieldBD != 'prt_incdate' && filterFieldBD != 'prt_upddate' && filterFieldBD != 'prt_deldate'">
					</div>
				...
				<div class="row">
			      	<div class="col-sm-12 right-justify">
			      		<div class="col-sm-4 col-sm-offset-6" style="margin-right: -20px;">
							<a href="" class="btn-block btn btn-xs btn-primary" data-dismiss="modal" ng-click="(lDeleted ? loadPrioridadeTicketDeletados(cFiltroManual) : loadPrioridadeTicket(cFiltroManual))">Aplicar filtro informado</a>
						</div>		
						<div class="col-sm-2">
