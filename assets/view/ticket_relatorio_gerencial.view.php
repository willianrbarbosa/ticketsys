...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
	<div class="kt-container  kt-container--fluid ">
		<div class="kt-subheader__main">
			...
			<div class="kt-subheader__breadcrumbs">
				<i class="fa fa-angle-double-right"></i>
				<a href="#/relatoriogerencial" class="kt-subheader__breadcrumbs-link bold">&nbsp;Relatório Gerencial</a>
			</div>
		</div>
		...
		<div class="col-xs-12 kt-portlet" >	
			...
			<div class="row kt-portlet__head kt-portlet__head--sm" style="padding-top: 15px;">
				<div class="col-xs-12">
					...
					<form name="rptForm" role="form" ng-show="aUserAccess.pta_nivel >= 3">
						<div class="row form-group">
				        	<div class="col-sm-3">
						        ...
						        <div ng-class="{ 'has-error': rptForm.tkt_rel_gen_data_de.$dirty && rptForm.tkt_rel_gen_data_de.$error.required }" >
						        	<div class="input-group">
						        		<span class="input-group-addon" style="font-size: 11px;"><i class="fa fa-lg fa-calendar"></i></span>
								    	<input type="text" name="tkt_rel_gen_data_de" id="tkt_rel_gen_data_de" class="form-control my-control iptdate" ng-model="reportFilter.tkt_rel_gen_data_de" placeholder="DD/MM/YYY" required/>
								    </div>
								</div>
					        </div>
				        	<div class="col-sm-3">
					        	<label>Data até</label><span class="txt-obg">*</span>
						        <div ng-class="{ 'has-error': rptForm.tkt_rel_gen_data_ate.$dirty && rptForm.tkt_rel_gen_data_ate.$error.required }" >
						        	<div class="input-group">
						        		<span class="input-group-addon" style="font-size: 11px;"><i class="fa fa-lg fa-calendar"></i></span>
								    	<input type="text" name="tkt_rel_gen_data_ate" id="tkt_rel_gen_data_ate" class="form-control my-control iptdate" ng-model="reportFilter.tkt_rel_gen_data_ate" placeholder="DD/MM/YYY" ng-blur="getCliRegTribByDate(reportFilter.data_ate);" required/>
								    </div>
								</div>
					        </div>
					        <div class="col-sm-3">
					...
					<div class="row form-group">
				        <div class="col-sm-4">
				        	<button type="button" ng-click="exportaDados('Relatório Gerencial Tickets<br>' + aTipoRel[reportFilter.tipo_rel-1].tpr_descr, 'tbRelGerencialTickets', 'EXCEL')" ng-show="aRelTicketsGerencial.HTMLFILE" class="btn btn-sm btn-block btn-success"><i class="fa fa-file-excel-o"></i> Gerar EXCEL</button>
					    </div>
				        <div class="col-sm-4">
				        	<button type="button" ng-click="exportaDados('Relatório Gerencial Tickets<br>' + aTipoRel[reportFilter.tipo_rel-1].tpr_descr, 'tbRelGerencialTickets', 'PDF')" ng-show="aRelTicketsGerencial.HTMLFILE" class="btn btn-sm btn-block btn-danger"><i class="fa fa-file-pdf-o"></i> Gerar PDF</button>
					    </div>
				        <div class="col-sm-4">
