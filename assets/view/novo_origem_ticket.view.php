		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-primary btn-salvar" ng-click="newForm.$invalid || novoOrigemTicket(nOrigemTicket, true)" ng-disabled="newForm.$invalid">
						Salvar
					</a>
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-success btn-salvar" ng-click="newForm.$invalid || novoOrigemTicket(nOrigemTicket, false)" ng-disabled="newForm.$invalid">
						Salvar e Cad. Novo
					</a>
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Nova Origem de Ticket', 'Cadastros', '#'+url)" class="kt-nav__link">
					...
					<form name="newForm" role="form" ng-show="aUserAccess.pta_nivel >= 1">
						<div class="form-group row">
					        <div class="col-sm-2">
					            ...
					            <input type="text" name="nov_ort_id" id="nov_ort_id" ng-maxlength="11" class="form-control my-control" ng-model="nOrigemTicket.ort_id" readonly />
					        </div>
								<div class="col-sm-10" ng-class="{ 'has-error': (newForm.nov_ort_descricao.$dirty && newForm.nov_ort_descricao.$error.required) || newForm.nov_ort_descricao.$error.maxlength }">
								  <label>Descrição</label><span class="txt-obg">*</span>
								  <input type="text" name="nov_ort_descricao" id="nov_ort_descricao"  ng-maxlength="50" maxlength="50" class="form-control my-control" ng-model="nOrigemTicket.ort_descricao"  required/>
								</div>
                            </div>
                       </form>
