		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-primary btn-salvar" ng-click="newForm.$invalid || newParametro(param)" ng-if="aUserAccess.pta_nivel >= 2" ng-disabled="newForm.$invalid">
						Salvar
					</a>
			...
			<div class="kt-portlet__body">
				...
				<form name="newForm" role="form" ng-show="aUserAccess.pta_nivel >= 2">
					...
					<div class="form-group row">
			        	<div class="col-sm-2">
				        	<label>Chave</label>
				            <input type="text" name="par_key" id="par_key" ng-maxlength="15" class="form-control my-control" ng-model="param.par_key" required />
				        </div>
				    </div>

					<div class="form-group row">
				        <div class="col-lg-12">		        	
					        <div ng-class="{ 'has-error': newForm.par_conteudo.$dirty && (newForm.par_conteudo.$error.required || newForm.par_conteudo.$error.maxlength) }" >
					        	<label>Conteúdo</label><span class="txt-obg">*</span>
					        	<textarea class="form-control my-control-txta" ng-model="param.par_conteudo" required></textarea>
					        </div>				       			        
				        </div>
				    </div>
					...
					<div class="form-group row">
				        <div class="col-sm-12">
					        <div ng-class="{ 'has-error': newForm.par_descricao.$dirty && newForm.par_descricao.$error.required }" >
				        		<label>Descrição</label><span class="txt-obg">*</span>		        		
					        	<textarea class="form-control my-control-txta" ng-model="param.par_descricao" required></textarea>
					        </div>
				        </div>
				    </div>
