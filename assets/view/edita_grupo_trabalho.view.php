		...
		<div class="kt-subheader__toolbar">
			<div class="kt-subheader__wrapper">
				<div class="dropdown dropdown-inline">
					...
					<a href="" ng-if="aUserAccess.pta_nivel >= 1" class="btn btn-xs btn-primary btn-salvar" ng-click="edtForm.$invalid || editaGrupoTrabalho(eGrupoTrabalho)" ng-if="aUserAccess.pta_nivel >= 2" ng-disabled="edtForm.$invalid">
						Salvar
					</a>
					...
					<div class="dropdown-menu dropdown-menu-fit dropdown-menu-md dropdown-menu-right">
						...
						<ul class="kt-nav">
							...
							<li class="kt-nav__item">
								<a href="" ng-click="NewUserFavorite('Editar Grupo de Trabalho ' + eGrupoTrabalho.grt_descricao, 'Cadastros', '#'+url)" class="kt-nav__link">
					...
					<form name="edtForm" role="form" ng-show="aUserAccess.pta_nivel >= 2">
						<div class="form-group row">
					        <div class="col-sm-2">
					            ...
					            <input type="text" name="nov_grt_id" id="nov_grt_id" ng-maxlength="11" class="form-control my-control" ng-model="eGrupoTrabalho.grt_id" readonly />
					        </div>
								<div class="col-sm-10" ng-class="{ 'has-error': (edtForm.nov_grt_descricao.$dirty && edtForm.nov_grt_descricao.$error.required) || edtForm.nov_grt_descricao.$error.maxlength }">
								  <label>Descrição</label><span class="txt-obg">*</span>
								  <input type="text" name="nov_grt_descricao" id="nov_grt_descricao"  ng-maxlength="50" maxlength="50" class="form-control my-control" ng-model="eGrupoTrabalho.grt_descricao"  required/>
								</div>
                            </div>
                       </form>
